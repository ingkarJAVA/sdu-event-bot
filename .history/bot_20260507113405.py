...
TOKEN = "8745442653:AAG5vAp4AtTAZqTkBHXgBUjNT6nVs6KlcVs"

# 2. Вставь сюда свой Telegram ID (число).
#    Как узнать свой ID: напиши боту @userinfobot в Telegram.
ADMIN_ID = 5654964951  # ← замени на свой реальный ID
...
async def received_name(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        "Ты придёшь на мероприятие 9 мая?",
